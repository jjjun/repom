...
class TestDisplayConfig:
    ...
    def test_display_config_sqlite(
        self, mock_get_models, mock_test_conn, mock_get_db_info, mock_config, capsys
    ):
        """Test display_config for SQLite."""
        mock_config.root_path = Path('/test/path')
        mock_config.backup_path = Path('/test/path/data/repom/backups')
        ...
        mock_test_conn.return_value = '(Not applicable for SQLite)'
    ...
    def test_display_config_postgresql(
        self, mock_get_models, mock_test_conn, mock_parse_url, mock_config, capsys
    ):
        ...
        mock_test_conn.return_value = '✓ Connected'
        mock_get_models.return_value = []
