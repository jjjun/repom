...
Implemented `rotate_backups()` in `repom/scripts/_backup_utils.py` and reused it from SQLite and PostgreSQL backup paths. Added unit tests for rotation boundary cases.
