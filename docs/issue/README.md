...
| ID | タイトル | 完了日 | 概要 | ファイル |
|----|---------|--------|------|---------|
| #044 | Compose プロジェクト名の config 対応 | 2026-02-24 | Config に project_name プロパティ追加（デフォルト: package_name）、Docker Compose に -p オプション実装、PostgresManager/RedisManager 自動対応、10 単体テスト追加、608 tests passing、config_hook_guide/postgresql_setup_guide/redis_manager_guide にドキュメント追加、複数プロジェクト同時起動対応完了 | [completed/044_compose_project_name_config.md](completed/044_compose_project_name_config.md) |
