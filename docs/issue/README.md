...
| #039 | MagicMock 生成ディレクトリの配置改善 | 2026-02-23 | mock_config.data_path を data/repom/ に固定し、MagicMock ディレクトリ生成を防止。Unit/Behavior テスト全パス | [completed/037_magicmock_artifact_path.md](completed/037_magicmock_artifact_path.md) |
